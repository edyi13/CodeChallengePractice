...
namespace WordFinderQu
{
    ...
    public class SolutionOptimized
    {
        ...
        public IEnumerable<string> Find(IEnumerable<string> matrix, IEnumerable<string> wordstream)
        {
            ...
            var horizontalTask = Task.Run(() => FindHorizontalOptimized(matrix.ToArray(), wordstream.ToArray()));
            var verticalTask = Task.Run(() => FindVerticalOptimized(matrix.ToArray(), wordstream.ToArray()));
        ...
        public static IEnumerable<string> FindHorizontalOptimized(string[] matrixArray, string[] wordstreamArray)
        {
        ...
        public static IEnumerable<string> FindVerticalOptimized(string[] matrixArray, string[] wordstreamArray)
        {
            List<string> words = new List<string>();
            // Create a HashSet of lowercase and trimmed words for efficient search
            HashSet<string> wordSet = new HashSet<string>(wordstreamArray.Select(w => w.ToLower().Trim()));
        ...
        public IEnumerable<string> GenerateMatrixOptimized(List<string> words, int matrixSize)
        {
